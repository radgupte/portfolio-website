    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p>
            This app was built using Angular 8. Users are able to search products 
            based on a name, category, or product code to retrieve a list of products 
            currently for sale.
          </p>
          <a
